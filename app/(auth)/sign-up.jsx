...
export default function Signup() {
  ...
  return (
    <StyledLinearGradient className="flex-1 justify-center items-center" colors={['#b0e0e6', '#87ceeb', '#4682b4', '#1e90ff']}>
        <StyledLinearGradient colors={['#a3d5e6', '#5fa8d3', '#3b5998']} className='w-[300] h-[460] pt-[20]  rounded-xl shadow-black' style={{ elevation: 10 }}>
          <StyledLinearGradient colors={['#ffffff00', '#ffffff20']} className='flex-1 rounded-xl'>
            <StyledView className="flex-col p-4 items-center">
              ...
              <StyledInput className="mb-5 text-black bg-white w-60 h-8" mode="outlined" label="Phone Number" keyboardType='phone-pad' placeholder="Enter Phone Number" placeholderTextColor={'black'} activeOutlineColor="#0e7490" />
